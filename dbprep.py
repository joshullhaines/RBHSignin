...
Curs.execute(
    ...
    " VALUES ('Josh Hull',"
    " 'Hull.joshua@gmail.com',"
    " '216 Virginia Ave, Rockville, MD 20850',"
    " '215-983-7600', 1)"
)
Curs.execute(
    "INSERT INTO VolunteerName"
    " VALUES ('Steve', 'None', 'None', 'None', 1)"
)
...
Curs.execute(
    ...
    "(Name PRIMARY KEY, Email, Address, PhoneNumber)"
)

Curs.execute("DROP TABLE SISOLOG")
Curs.execute(
    "CREATE TABLE SISOLOG"
...
Curs.execute(
    "INSERT INTO SISOLOG (Name, Date, Timein)"
    " VALUES (?, ?, ?)",
    [Name, Date, TimeOfDay],
)
db.commit()
